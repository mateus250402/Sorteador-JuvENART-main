...
export const lista_cabeca = [pia_do_sul, estancia_da_serra, aldeia_farroupilha, patrulha_do_rio_grande, cftg, herois_farroupilhas];
...
export let lista_geral = [felipe_portinho, camboata, os_farrapos, gt_sepe_tiaraju, charrua, lalau_miranda, alma_gaucha_18, guapos_do_itapui, amanhecer_na_querencia, velha_carreta];
